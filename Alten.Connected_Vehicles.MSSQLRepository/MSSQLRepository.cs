...
namespace Alten.Connected_Vehicles.MSSQLRepository
{
    ...
    public partial class MSSQLRepository<T> : IRepository<T>, IRepositoryExtension<T>, IRepositoryAsyncExtension<T>, IRepositoryAsync<T> , IDisposable where T : class
    {
        #region Data Members
        /// <summary>
        ...
        #region Data retribval Operations 
